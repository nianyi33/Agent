      ...
      parameters: {
        ...
        properties: {
          ...
          placement: {
            ...
            description: 'Optional window placement. Default auto avoids the main TreeSloth AI Agent window when possible; call status first if you need exact screen/window bounds.'
          },
          bounds: {
            type: 'object',
            properties: {
