...
To add one from inside TreeSloth AI Agent, create a folder under sandbox_root with a SKILL.md containing YAML frontmatter name and description. Skills under root are also supported for externally installed packages.
