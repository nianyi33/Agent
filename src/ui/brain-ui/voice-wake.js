...
//
// 命中「TreeSloth」由主进程经 IPC `wake:hit` 通知本渲染层(见 preload.cjs 的 treesloth-ai-agent.wake)。
...
export function createWakeFlow(core) {
  const orb = (typeof window !== 'undefined' && window.treesloth-ai-agent && window.treesloth-ai-agent.wake) || null;
