...
const ROLE_RULES = [
  {
    ...
    keywords: [/treesloth/i, /agent/i, /llm/i, /prompt/i, /context/i, /memory/i, /codex/i, /claude/i, /openai/i, /minimax/i],
...
function inferProjects(text) {
  const projects = []
  if (/treesloth/i.test(text)) projects.push('TreeSloth AI Agent')
