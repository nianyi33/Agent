---
name: Coding
description: Coding discipline â€?write code in vertical slices, verify after each change, touch only what was asked, match existing style, and never restructure code you were not told to restructure.
tags:
  - coding
  - engineering
  - development
...
After every change: produce evidence it works â€?run it, fetch it, verify the output. "Tested" from reading the code is not tested.
