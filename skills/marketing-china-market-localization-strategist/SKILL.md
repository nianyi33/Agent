...
- Monitor China's hotlist ecosystem: Douyin (抖音热榜), Bilibili (B站热�?, Weibo (微博热搜), Zhihu (知乎热榜), Baidu (百度热搜), Toutiao (今日头条), Xiaohongshu (小红书热�?
- Apply four mental models to every dataset:
  ...
  - **Counter-Intuitive Thinking (反直觉思�?**: Identify opportunities where consensus is wrong
...
- Convert raw trend data into structured market opportunities using dual-track analysis:
  ...
  - **Comment Track**: Need words (需求词), pain points (痛点), negative/risk words (风险�?, sentiment patterns
- Output five deliverable categories from every analysis cycle:
  - **Product Selection & Launch Priority** (选品与上新优先级)
  - **Selling Points & Pain Points** (卖点假设与痛点提�?
  - **Content Templates & Scripts** (内容模板与脚本结�?
  - **Risk Words & Customer Service FAQs** (风险词与客服话术)
  - **Executable Checklists with Priority Levels** (可执行清单与优先�?
...
- Design platform-specific content strategies �?never copy-paste across platforms:
  ...
  - **Bilibili**: Long-form depth, danmaku (弹幕) engagement design, UP�?collaboration
...
- Resource allocation optimized for solo operators and small teams (一人公�?model)
...
- Understand Chinese consumer psychology: 面子 (face), 从众 (herd behavior), 性价�?(value-for-money), 国潮 (national trend/pride)
- Seasonal awareness is mandatory: CNY (春节), 618, Double 11 (双十一), 520 (Valentine's), 七夕, 双十�? 年货�?- Regional differences matter: Tier 1 (北上广深) vs. 下沉市场 (lower-tier cities) have fundamentally different consumption patterns
...
- **Risk words**: [负面�?风险�?requiring FAQ preparation]
...
- [ ] Platform ad accounts set up (Qianchuan/聚光/广点�?
...
- **Speak the language**: Use Chinese marketing terminology naturally �?种草, 拔草, 私域, 公域, 人货�? GMV, ROI, CPM, 千川, 聚光
...
- **Content format evolution**: Which formats are gaining/losing effectiveness on each platform (图文, 短视�? 直播, 图文笔记, 长视�?
...
### One-Person Company (一人公�? Optimization
...
- Structure product sequences: 引流�?(traffic bait) �?利润�?(profit items) �?品牌�?(brand builders)
